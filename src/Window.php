...
//            $this->border(ord('║'), ord('║'), ord('═'), ord('═'), ord('╔'), ord('╗'), ord('╚'), ord('╝'));
    ...
    public function border(
        ...
        ncurses_wborder($this->windowResource, $left, $right, $top, $bottom,
     ...
     */
    static public function createCenteredOf(
        Window $parentWindow,
        $columns,
        $rows
    ) {
        ...
        return new Window($columns, $rows, ($max_columns / 2 - $columns / 2),
            ($max_rows / 2 - $rows / 2));
    }
}
